"""Серверный объект заказа Буки — единый источник правды по составу и суммам.
...
def render_summary(order: dict[str, Any]) -> str:
    ...
    lines.append("")
    lines.append("Давайте переведём диалог в удобный Вам мессенджер. "
                 "Так у Вас сохранится контакт с нами на будущее. Куда удобно?")
    lines.append("")
    lines.append("Или напишите свой номер телефона, мы с Вами свяжемся.")
    return "\n".join(lines)
