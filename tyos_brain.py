"""Мозг текстового ИИ-консультанта «Тёс».
...
# реплика (клиент или Тёс) с session_id и временем.
...
# Самопредставление и приветствие Тёс уже показаны в приветствии (клиентская часть
...
def _strip_reintro(text: str) -> str:
    """Срезать ведущие предложения-вступления (приветствие / «я Тёс, ИИ-консультант» /
